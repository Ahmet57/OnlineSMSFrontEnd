...
url["PutEnrollment"] = host + "api/courses/putEnrollment/";
url["PutDisEnrollment"] = host + "api/courses/putDisEnrollment/";
url["PutCourseByID"] = host + "api/courses/putCourseByID/";
...
var App = angular.module('angle', ['ngRoute', 'ngAnimate', 'ngStorage', 'ngCookies', 'pascalprecht.translate', 'ui.bootstrap', 'ui.router', 'oc.lazyLoad', 'cfp.loadingBar'])
          .run(["$rootScope", "$state", "$stateParams",  '$window', '$templateCache', function ($rootScope, $state, $stateParams, $window, $templateCache) {
              ...
              $rootScope.viewAllStudents = {
                  "text": "Tüm Öğrencileri Görüntüle",
                  "sref": "app.viewAllStudents",
                  "icon": "icon-speedometer",
                  "translate": "sidebar.nav.VIEW_ALL_STUDENTS"
              }
              $rootScope.viewAllCourses = {
                  "text": "Tüm Dersleri Görüntüle",
                  "sref": "app.viewAllCourses",
                  "icon": "icon-speedometer",
                  "translate": "sidebar.nav.VIEW_ALL_COURSES"
              }
              $rootScope.viewAllTeachers = {
                  "text": "Tüm Öğretmenleri Görüntüle",
                  "sref": "app.viewAllTeachers",
                  "icon": "icon-speedometer",
                  "translate": "sidebar.nav.VIEW_ALL_TEACHERS"
              }
              $rootScope.addStudent = {
                  "text": "Öğrenci Ekle",
                  "sref": "app.addStudent",
                  "icon": "icon-speedometer",
                  "translate": "sidebar.nav.ADD_STUDENT"
              }
              $rootScope.addTeacher = {
                  "text": "Öğretmen Ekle",
                  "sref": "app.addTeacher",
                  "icon": "icon-speedometer",
                  "translate": "sidebar.nav.ADD_TEACHER"
              }
              $rootScope.addCourse = {
                  "text": "Ders Ekle",
                  "sref": "app.addCourse",
                  "icon": "icon-speedometer",
                  "translate": "sidebar.nav.ADD_COURSE"
              }
              $rootScope.listCoursesStudent = {
                  "text": "Desleri Listele ve Kaydol",
                  "sref": "app.listCoursesStudent",
                  "icon": "icon-speedometer",
...
function ($stateProvider, $urlRouterProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $ocLazyLoadProvider, appRequires) {
  ...
  $stateProvider
    ...
    .state('app.dashboard', {
      ...
      .state('app.viewAllStudents', {
          url: '/viewAllStudents',
          title: 'Tum Ogrencileri Goruntule',
          templateUrl: basepath('myViews/viewAllStudents.html'),
          controller: 'ViewAllStudentsController',
          resolve: resolveFor('jquery-ui', 'moment')
      })
      .state('app.viewAllTeachers', {
          url: '/viewAllTeachers',
          title: 'Tum Ogretmenleri Goruntule',
          templateUrl: basepath('myViews/viewAllTeachers.html'),
          controller: 'ViewAllTeachersController',
          resolve: resolveFor('jquery-ui', 'moment')
      })
      .state('app.viewAllCourses', {
          url: '/viewAllCourses',
          title: 'Tum Dersleri Goruntule',
          templateUrl: basepath('myViews/viewAllCourses.html'),
          controller: 'ViewAllCoursesController',
          resolve: resolveFor('jquery-ui', 'moment')
      })
      .state('app.addStudent', {
          url: '/addStudent',
          title: 'Yeni Ogrenci Ekle',
          templateUrl: basepath('myViews/addStudent.html'),
          controller: 'AddStudentController',
          resolve: resolveFor('jquery-ui', 'moment')
      })
      .state('app.addTeacher', {
          url: '/addTeacher',
          title: 'Yeni Ogretmen Ekle',
          templateUrl: basepath('myViews/addTeacher.html'),
      ...
      .state('app.addCourse', {
          ...
          templateUrl: basepath('myViews/addCourse.html'),
          controller: 'AddCourseController',
          resolve: resolveFor('jquery-ui', 'moment')
      })
      .state('app.listCoursesTeacher', {
          url: '/listCoursesTeacher',
          title: 'List Courses',
          templateUrl: basepath('myViews/listCoursesTeacher.html'),
      ...
      .state("app.editCourseByID", {
          ...
          title: 'Edit Course',
          params: { id: null },
          templateUrl: basepath('myViews/editCourseByID.html'),
          controller: "EditCourseByIDController"
      })
      .state('app.live', {
          url: '/live',
          title: 'Live',
          templateUrl: basepath('myViews/live.html'),
      ...
      .state('app.library', {
          url: '/library',
          title: 'Library',
          templateUrl: basepath('myViews/library.html'),
      ...
      .state('app.S_And_C', {
          url: '/S_And_C',
          title: 'S_And_C',
          templateUrl: basepath('myViews/S_And_C.html'),
          controller: 'S_And_CController',
          resolve: resolveFor('jquery-ui', 'moment', 'fullcalendar')
      })
    .state('app.widgets', {
        url: '/widgets',
...
App.controller("AddTeacherController", function ($scope, $http, $window, $state) {
    // get all courses first to chose in combobox
    ...
    $scope.saveTeacher = function () {
        ...
        var onSuccess = function (response) {
            $window.alert("Teacher saved successfully");
            $state.reload();
        }
        ...
        $http({
            method: 'POST',
            data: teacher,
            url: url["TeachersPost"],
        }).then(onSuccess, onFailure);
        $state.reload();
    };
})

App.controller("ViewAllTeachersController", function ($scope, $http, $state) {
    var onSucess = function (response) { $scope.teachers = response.data }
    var onFailure = function (reason) { $scope.error = reason }
    ...
    $scope.deleteTeacher = function (teacherID) {
        var onSuccess = function (response) { getAllTeachers(); $state.reload(); }
        var onFailure = function (reason) { $scope.error = reason }
        $http({
            method: 'DELETE',
            url: url["TeachersDelete"],
            params: { teacherID: teacherID }
        }).then(onSuccess, onFailure);
    }
})

App.controller("ViewAllStudentsController", function ($scope, $http, $state) {
    ...
    $scope.deleteStudent = function (studentID) {
        var onSuccess = function (response) { getAllStudents(); $state.reload(); }
        var onFailure = function (reason) { $scope.error = reason }
        $http({
            method: 'DELETE',
...
App.controller("AddStudentController", function ($scope, $http, $window, $state) {
    $scope.saveStudent = function () {
        var student = {
            ...
            ContactNo: $scope.StudentContactNo,
            EnrolledCourses: " "
        };
        var onSuccess = function (response) {
        ...
        $http({
            method: 'POST',
            data: student,
            url: url["StudentsPost"],
        }).then(onSuccess, onFailure);
        $state.reload();
    };
})

App.controller("ViewAllCoursesController", function ($scope, $http, $state) {
    var onSucess = function (response) { $scope.courses = response.data }
    var onFailure = function (reason) { $scope.error = reason }
    var getAllCourses = function () {
        $http({
    ...
    $scope.deleteCourse = function (courseID) {
        var onSuccess = function (response) { getAllCourses(); $state.reload();}
        var onFailure = function (reason) { $scope.error = reason }
        $http({
            method: 'DELETE',
            url: url["CoursesDelete"],
...
App.controller("ListCoursesStudentController", function ($rootScope, $scope, $http, $state) {
    var onSucess = function (response) { $scope.courses = response.data }
    var onFailure = function (reason) { $scope.error = reason }
    var getAllCourses = function () {
        $http({
    ...
    getAllCourses();
    $scope.checkIfEnrolled = function (course) {
        var enrolledStudents = course.EnrolledStudents.split(',');
        var found = false;
        var loginedStudenName = $rootScope.user.object.StudentName;
        var loginedStudentSurname = $rootScope.user.object.StudentSurname;
        for (var i = 0; i < enrolledStudents.length; i++) {
            if (enrolledStudents[i] == (loginedStudenName + " " + loginedStudentSurname)) {
                found = true;
            }
        }
        return found;
    ...
    $scope.enrollCourse = function (course) {
        var enrolled = $scope.checkIfEnrolled(course);
...
App.controller("EditCourseByIDController", function ($scope, $http, $stateParams, $state, $location) {
    $scope.saveChanges = function () {
        var startTime = document.getElementById('startTime').value;
        var endTime = document.getElementById('endTime').value;
        var context = document.getElementById('context').value;
        var courseID = $stateParams.id;
        var onSucess = function (response) { $state.go("app.listCoursesTeacher", {}, { reload: true }); }
        var onFailure = function (reason) { this.error = reason }
        $http({
            method: 'PUT',
            url: url["PutCourseByID"],
...
App.controller("S_And_CController", function ($scope, $http) {
    var onSucess = function (response) { $scope.courses = response.data }
    var onFailure = function (reason) { $scope.error = reason }
    var getAllCourses = function () {
        $http({
...
App.controller('LoginFormController', function ($rootScope, $scope, $state, $http, $window) {
    $scope.Login = async function ()
    {
        ...
        if (strUser == "admin") {
            ...
            var onFailure = function (reason) { this.error = reason }
            if ((admin.data != null) && (admin.data != "null")) {
                var adminToSend = admin.data;
                $rootScope.user = {
                    name: adminToSend.UserName,
                    job: 'Admin',
                    picture: 'app/img/user/02.jpg',
                    object: adminToSend
                };
                $state.go("app.dashboard", { data: adminToSend });
            }
            else {
            ...
            var onSucess = function (response) { return response.data; }
            var onFailure = function (reason) { this.error = reason }
            if ((teacher.data != null) && (teacher.data != "null")) {
                var teacherToSend = teacher.data;
                $rootScope.user = {
                    name: teacherToSend.TeacherName,
                    job: 'Teacher',
                    picture: 'app/img/user/02.jpg',
                    object: teacherToSend
                };
                $state.go("app.dashboard", { data: teacherToSend });
            }
            else {
                $window.alert("UserName or Password are incorrect.");
            }
        ...
        else if (strUser == "ogrenci")
        {
            ...
            var onSucess = function (response) { return response.data; }
            var onFailure = function (reason) { this.error = reason }
            if ((student.data != null) && (student.data != "null")) {
                var studentToSend = student.data;
                $rootScope.user = {
                    name: studentToSend.StudentName + " " + studentToSend.StudentSurname,
                    job: 'Student',
                    picture: 'app/img/user/02.jpg',
                    object: studentToSend
                };
                $state.go("app.dashboard", { data: studentToSend });
            }
            else {
                $window.alert("UserName or Password are incorrect.");
            }
      ...
      $scope.loadSidebarMenu = function () {
          ...
          var items = [
              ...
              },
              {
                  ...
                  "sref": "app.calendar",
                  "icon": "icon-speedometer",
                  "translate": "sidebar.nav.CALENDAR"
              },
              {
                  "text": "Canlı",
                  "sref": "app.live",
                  "icon": "icon-speedometer",
                  "translate": "sidebar.nav.LIVE"
              },
              {
                  "text": "Kütüphane",
                  "sref": "app.library",
              ...
              },
              {
                  ...
                  "heading": "true",
                  "translate": "sidebar.heading.USER"
              },
              {
                  "text": "Test/Sınav İşlemleri",
                  "heading": "true",
              ...
              },
              {
                  ...
                  "sref": "app.widgets",
                  "icon": "icon-speedometer",
                  "translate": "sidebar.nav.QUESTION_POOL"
              },
              {
                  "text": "Test Havuzu",
                  "sref": "app.widgets",
                  "icon": "icon-speedometer",
                  "translate": "sidebar.nav.TEST_POOL"
              },
              {
                  "text": "Test Kategorileri",
                  "sref": "app.widgets",
                  "icon": "icon-speedometer",
                  "translate": "sidebar.nav.TEST_CATEGORIES"
              },
              {
                  "text": "Anket Soruları",
                  "sref": "app.widgets",
                  "icon": "icon-speedometer",
                  "translate": "sidebar.nav.SURVEY_QUESTIONS"
              },
              {
                  "text": "Diğer",
                  "heading": "true",
          ...
          if ($rootScope.user.job == "Admin") {
              $rootScope.menuItems.splice(8, 0, $rootScope.viewAllStudents);
              $rootScope.menuItems.splice(9, 0, $rootScope.viewAllTeachers);
              $rootScope.menuItems.splice(10, 0, $rootScope.viewAllCourses);
              $rootScope.menuItems.splice(11, 0, $rootScope.addStudent);
              $rootScope.menuItems.splice(12, 0, $rootScope.addTeacher);
   ...
   /*
      ...
      $http.get(menuURL)
        .success(function(items) {
            ...
            // do some modification on menu items
            // if admin
            if ($rootScope.user.job == "Admin") {
                $rootScope.menuItems.splice(8, 0, $rootScope.viewAllStudents);
                $rootScope.menuItems.splice(9, 0, $rootScope.viewAllTeachers);
